...
/** Image décorative distante : img native pour éviter l’optimiseur Next en standalone / Docker. */
    ...
    <div className="pointer-events-none fixed bottom-10 right-10 z-0 hidden aspect-square w-[320px] lg:block">
      <GlassPanel className="h-full w-full p-1">
        <div className="relative h-full w-full overflow-hidden rounded-lg">
          {/* eslint-disable-next-line @next/next/no-img-element -- hors LCP, chargement lazy */}
          <img
